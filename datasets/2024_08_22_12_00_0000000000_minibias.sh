...
# (prun_jobs.py -c "simu_trf.py -i %IN -o %OUT -nt $n_workers -t 10" -nt $n_workers -i "${base_dir}/EVT" -o "${base_dir}/HIT/minibias.HIT.root" |& tee "${base_dir}/minibias.HIT.log") && \
...
(prun_jobs.py -c "digit_trf.py -i %IN -o %OUT" -i "${base_dir}/HIT" -o "${base_dir}/ESD/minibias.ESD.root" -nt $n_workers |& tee "${base_dir}/minibias.ESD.log") && \
...
(prun_jobs.py -c "reco_trf.py -i %IN -o %OUT" -i "${base_dir}/ESD" -o "${base_dir}/AOD/minibias.AOD.root" -nt $n_workers -m |& tee "${base_dir}/minibias.AOD.log" )  && \
