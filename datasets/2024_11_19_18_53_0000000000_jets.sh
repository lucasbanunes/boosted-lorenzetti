...
# Usage example 
# 2024_11_19_18_53_0000000000_jets.sh <n_workers>
# 2024_11_19_18_53_0000000000_jets.sh 10
# This will generate a dataset using 10 workers
call_dir=$PWD
NOV=10000 && \
n_workers=$1 && \
seed=2137420 && \
...
(prun_jobs.py -c "reco_trf.py -i %IN -o %OUT -l DEBUG" -i "${base_dir}/ESD" -o "${base_dir}/AOD/jf17.AOD.root" -nt $n_workers |& tee "${base_dir}/jf17.AOD.log" )  && \
