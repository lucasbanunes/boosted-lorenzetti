...
from boosted_lorenzetti.kan.cli import create_training, run_training, create_kfold, run_kfold


def test_kan_full_training(test_dataset_path: Path):
    experiment_name = 'test_kan_full_training'
...
def test_kan_multiple_trainings(test_dataset_path: Path, repo_path: Path):
    experiment_name = 'test_kan_multiple_trainings'
...
def test_kan_kfold_training(test_dataset_path: Path):
    experiment_name = 'test_kan_kfold_training'
...
def test_kan_create_kfold_cli(test_dataset_path: Path, repo_path: Path):
    experiment_name = 'test_kan_create_kfold_cli'
