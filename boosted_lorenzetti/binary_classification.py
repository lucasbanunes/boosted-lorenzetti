...
#         return self.model.parse_object_dict(parse_inner_objs=True)

#     @cached_property
#     def datamodule_obj(self) -> Any:
#         return self.datamodule.parse_object_dict(parse_inner_objs=True)
...
#         class_weights = self.datamodule_obj.get_class_weights(
#             how='balanced'
#         )
